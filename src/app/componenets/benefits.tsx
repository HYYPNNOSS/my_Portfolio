...
function Benefits(){
    ...
    return(
        <>
        <section ref={sectionRef} className="min-h-[100vh] bg-[#f6f6f6] w-full p-4 md:p-8 lg:p-[64px]">
            <div ref={contentRef} className="max-w-7xl mx-auto">
                ...
                <button className="w-fit h-fit bg-black px-4 py-2 my-4 rounded-[5px] gap-[8px] flex items-center birds mx-auto">
                ...
                <div className="border-t-2 text-black py-4 border-b-2 flex flex-col md:flex-row justify-between border-black w-full">
                    <h3 className="text-black text-[24px] sm:text-[28px] md:text-[32px] font-bold mb-4 birds">
                        ✦ Understand Goals & Examination ✦
                    </h3>
                    <div className="w-full md:w-[450px] text-[16px] md:text-[18px] font-semibold text-black">
                        <ul>
                            <li>
                ...
                <div className="text-black border-b-2 flex flex-col md:flex-row py-4 justify-between border-black w-full">
                    <h3 className="text-black text-[24px] sm:text-[28px] md:text-[32px] font-bold mb-4 birds">
